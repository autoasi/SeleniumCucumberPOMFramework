...
import cucumberbdd.pages.ProductPage;
...
public class ProductStepDefinitions {
    ...
    public void iMBrowsing(Product product) {
        productPage.load("/product/" + product.getName().replaceAll("\s","-") + "/");
        context.product = product;
    }

    @When("I add {int} quantity to the cart")
    public void iAddQuantityQuantityToTheCart(int quantity) {
    ...
    public void theSelectedQuantityIsCurrentQuantity(int currentQuantity) {
    ...
    public void iShouldSeeTheBannerWithText(String text) {
